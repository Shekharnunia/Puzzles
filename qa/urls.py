...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/(?P<slug>[-\w]+)/close/$',
        views.QuestionDetaiCloseView.as_view(),
        name='question_close'),
    ...
    path('<int:pk>/<slug:slug>/detele-answer/<uuid:answer_id>/',
         views.DeleteAnswerView.as_view(),
         name='delete_answer'),

    path('<int:pk>/<slug:slug>/edit-answer/<uuid:answer_id>/',
         views.EditAnswerView.as_view(),
         name='edit_answer'),

    path('<int:pk>/<slug:slug>/flag/<uuid:answer_id>/',
         views.a_flag,
         name='flag_answer'),
